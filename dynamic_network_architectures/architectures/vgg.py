...
_VGG_CONFIGS = {
    "16": {
        "features_per_stage": (64, 128, 256, 512, 512, 512),
        "n_conv_per_stage": (2, 2, 2, 3, 3, 3),
        "strides": (1, 2, 2, 2, 2, 2),
    },
    "19": {
        "features_per_stage": (64, 128, 256, 512, 512, 512),
        "n_conv_per_stage": (2, 2, 3, 3, 4, 4),
        "strides": (1, 2, 2, 2, 2, 2),
    },
    "16_cifar": {
        "features_per_stage": (64, 128, 256, 512),
        "n_conv_per_stage": (2, 3, 5, 5),
        "strides": (1, 2, 2, 2),
    },
    "19_cifar": {
        "features_per_stage": (64, 128, 256, 512),
        "n_conv_per_stage": (3, 4, 5, 6),
        "strides": (1, 2, 2, 2),
    },
}
...
class VGG(AbstractDynamicNetworkArchitectures):
    def __init__(self, n_classes: int, n_input_channel: int = 3, config="16", input_dimension=2):
        ...
        self.keys_to_in_proj = (
            ...
            "encoder.stages.0.0.convs.0.all_modules.0",  # duplicate of above
        )
        ...
        self.encoder = PlainConvEncoder(
            n_input_channel,
            n_stages=len(cfg["features_per_stage"]),
